...
ggsave(filename = paste0("results/figures/pdf/figure-4L-founder-eQTL-validation-Tmx1.pdf"),
       plot = tmx1_plot,
       dpi = 330,
       width = 7,
       height = 5)
...
ggsave(filename = paste0("results/figures/pdf/figure-4L-founder-eQTL-validation-Ywhah.pdf"),
       plot = ywhah_plot,
       dpi = 330,
       width = 7,
       height = 5)
...
ggsave(filename = paste0("results/figures/pdf/figure-4L-founder-eQTL-validation-Ywhag.pdf"),
       plot = ywhag_plot,
       dpi = 330,
       width = 7,
       height = 5)
...
ggsave(filename = paste0("results/figures/pdf/figure-4L-founder-eQTL-validation-Hopx.pdf"),
       plot = hopx_plot,
       dpi = 330,
       width = 7,
       height = 5)
...
ggsave(filename = paste0("results/figures/pdf/figure-4L-founder-eQTL-validation-Aim2.pdf"),
       plot = aim2_plot,
       dpi = 330,
       width = 7,
       height = 5)
...
ggsave(filename = paste0("results/figures/pdf/figure-4L-founder-eQTL-validation-Cnn2.pdf"),
       plot = cnn2_plot,
       dpi = 330,
       width = 7,
       height = 5)
